  ...
  return (
    <>
      <p>
        ...
        Tailwind as our core CSS framework, most of the UI in Mempoverse Admin
        is built entirely with it features, so you can easily update the theme &
        base by altering <code>tailwind.config.js</code> under the root
        directory.
      </p>
