...
const Installation = () => {
  return (
    <>
      <h6>Prerequisites</h6>
      <p>
        Before you begin with Mempoverse Admin, you may need to install the
        following tools make sure your development environment able to run the
        template.
      </p>
      <div className="mt-6">
        <ul>
      ...
      <div className="mt-8">
        <h6>Installing Mempoverse Admin</h6>
        <p>
